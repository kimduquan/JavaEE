 ...
 */
@TopCommand
@Command(name = "epf", subcommands = {Security.class, Persistence.class, Query.class, Schema.class, FileStore.class, Rules.class, Utility.class, Image.class, Messaging.class, Health.class})
@ApplicationScoped
