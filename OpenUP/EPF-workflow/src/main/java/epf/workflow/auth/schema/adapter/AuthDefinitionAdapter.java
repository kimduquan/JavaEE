package epf.workflow.auth.schema.adapter;
...
import epf.workflow.auth.schema.BasicPropertiesDefinition;
import epf.workflow.auth.schema.BearerPropertiesDefinition;
import epf.workflow.auth.schema.OAuth2PropertiesDefinition;
