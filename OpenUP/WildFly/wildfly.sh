...
kubectl create cm oidc --from-literal=OIDC_PROVIDER_URI='http://host.docker.internal/realms/EPF/.well-known/openid-configuration' --from-literal=OIDC_CLIENT_ID='oidc-client'
