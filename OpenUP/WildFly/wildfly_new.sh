...
kubectl create cm oidc --from-literal=OIDC_PROVIDER_URI='https://localhost/openid/realms/EPF/.well-known/openid-configuration' --from-literal=OIDC_CLIENT_ID='oidc-client'
