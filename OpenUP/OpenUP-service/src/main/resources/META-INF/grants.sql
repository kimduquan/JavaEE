...
GRANT SELECT ON SCHEMA PUBLIC TO Any_Role;
GRANT SELECT ON SCHEMA PUBLIC TO Architect;
GRANT SELECT ON SCHEMA PUBLIC TO Developer;
GRANT SELECT ON SCHEMA PUBLIC TO Project_Manager;
GRANT SELECT ON SCHEMA PUBLIC TO Stakeholder;
GRANT SELECT ON SCHEMA PUBLIC TO Tester;
...
/*Deployment BEGIN*/
GRANT SELECT ON SCHEMA PUBLIC TO Course_Developer;
GRANT SELECT ON SCHEMA PUBLIC TO Deployment_Engineer;
GRANT SELECT ON SCHEMA PUBLIC TO Deployment_Manager;
GRANT SELECT ON SCHEMA PUBLIC TO Product_Owner;
GRANT SELECT ON SCHEMA PUBLIC TO Technical_Writer;
GRANT SELECT ON SCHEMA PUBLIC TO Trainer;
...
/*Environment BEGIN*/
GRANT SELECT ON SCHEMA PUBLIC TO Process_Engineer;
GRANT SELECT ON SCHEMA PUBLIC TO Tool_Specialist;
