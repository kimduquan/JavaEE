...
#sudo dnf install --enablerepo=downloads.whamcloud.com_public_lustre_latest-release_el8.10_server --enablerepo=downloads.whamcloud.com_public_e2fsprogs_latest_el8 kernel
