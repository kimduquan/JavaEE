...
public class Schema {
	...
	class Group {
		String name;
		List<User> users;
		List<ModelAccess> model_access; // Access Controls
		List<Rule> rule_groups;
		List<Menu> menu_access; // Access Menu
		List<View> view_access; // Views
		String comment;
	...
	class View {
		...
		List<View> inherit_childrens; // Views which inherit from this one
	...
	class User extends Partner {
		...
		List<UserSetting> res_users_settings;
	...
	class PartnerCategory {
		...
		List<PartnerCategory> childs; // Child Tags
		boolean active = true;
		String parent_path;
	 ...
	 */
	class CurrencyRate {
		Date name = Date.from(Instant.now()); // Date
	...
	class Country {
		...
		List<CountryGroup> country_groups; // Country Groups
		List<CountryState> countryStates; // States
	...
	class Company {
		...
		List<Company> childs; // Branches
		List<Company> all_childs;
		String parent_path;
		...
		Currency currency; // Currency
		List<User> users; // Accepted Users
		String street;
		String street2;
		String zip;
		String city;
		...
		List<Module> uninstalled_l10n_modules;
	}
