...
public class Module {
	 ...
	 */
	@Column(updatable = false)
	@OneToMany(targetEntity = ModuleDependency.class)
	@ElementCollection(targetClass = ModuleDependency.class)
	 ...
	 */
	@Column(updatable = false)
	@OneToMany(targetEntity = ModuleExclusion.class)
	@ElementCollection(targetClass = ModuleExclusion.class)
