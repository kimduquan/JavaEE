...
@JsonClassDescription("Defines the fundamentals of an 'oauth2' authentication.")
public class OAUTH2Authentication {
	
	public class Endpoints {
		
		@JsonPropertyDescription("The relative path to the endpoint for OAuth2 token requests. Defaults to /oauth2/token.")
		private URI token = URI.create("/oauth2/token");
		
		@JsonPropertyDescription("The relative path to the endpoint used to invalidate tokens. Defaults to /oauth2/revoke.")
		private URI revocation = URI.create("/oauth2/revoke");
		
		@JsonPropertyDescription("The relative path to the endpoint used to validate and obtain information about a token, typically to check its validity and associated metadata. Defaults to /oauth2/introspect.")
		private URI introspection = URI.create("/oauth2/introspect");
		...
		public void setIntrospection(URI introspection) {
	...
	@NotNull
	@JsonPropertyDescription("The URI that references the authority to use when making OAuth2 calls.")
