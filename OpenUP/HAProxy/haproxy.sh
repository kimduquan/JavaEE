...
#https://artifacthub.io/packages/helm/haproxytech/kubernetes-
kubectl apply -f tcp.yaml
helm install haproxy-kubernetes-ingress oci://ghcr.io/haproxytech/helm-charts/kubernetes-ingress -f values.yaml