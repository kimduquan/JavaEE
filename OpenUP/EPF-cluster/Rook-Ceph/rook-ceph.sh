...
helm --kubeconfig=${EPF_CLUSTER_KUBE_CONFIG} upgrade --install ceph-csi-drivers --namespace rook-ceph --wait ceph-csi-operator/ceph-csi-drivers -f csi-values.yaml