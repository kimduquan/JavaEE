...
kubectl wait deployment --for condition=available --timeout=90s supavisor
kubectl wait pod --for condition=ready --timeout=90s -l app.kubernetes.io/name=supavisor
