...
import openup.ejb.guidance.templates.RiskList;
...
public class ProjectRisk implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProjectRisk)) {
            return false;
        }
        ProjectRisk other = (ProjectRisk) object;
    ...
    public String toString() {
        return "openup.ejb.work_product_slot.ProjectRisk[ id=" + id + " ]";
    }
    
    @ElementCollection
    @OneToMany
    private List<RiskList> FulfillingWorkProducts;
     ...
     */
    public List<RiskList> getFulfillingWorkProducts() {
     ...
     */
    public void setFulfillingWorkProducts(List<RiskList> FulfillingWorkProducts) {
